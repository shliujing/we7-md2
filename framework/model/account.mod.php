...
function uni_modules_by_uniacid($uniacid, $enabled = true) {
	...
	if (!empty($modules)) {
		foreach ($modules as $name => $module) {
			...
			if ($module_info['welcome_support'] != MODULE_SUPPORT_SYSTEMWELCOME &&($module_info['app_support'] != MODULE_SUPPORT_ACCOUNT && in_array($_W['account']['type'], array(ACCOUNT_TYPE_OFFCIAL_NORMAL, ACCOUNT_TYPE_OFFCIAL_AUTH)) ||
