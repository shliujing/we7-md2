	...
	if (is_array($module_file) && !empty($module_file)) {
		foreach ($module_file as $modulepath) {
			...
			if (file_exists(IA_ROOT.'/addons/'.$module_info['name'].'/icon-custom.jpg')) {
				$module_info['thumb'] = tomedia(IA_ROOT.'/addons/'.$module_info['name'].'/icon-custom.jpg');
			} elseif (file_exists(IA_ROOT.'/addons/'.$module_info['name'].'/icon.jpg')) {
				$module_info['thumb'] = tomedia(IA_ROOT.'/addons/'.$module_info['name'].'/icon.jpg');
			} else {
				$module_info['thumb'] = tomedia($module['thumb']);
			}				
