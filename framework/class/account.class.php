...
class WeUtility {
	...
	public static function createModule($name) {
		...
		file_put_contents("log--res.txt","\n new:".(is_array($GLOBALS['_' . chr('180') . chr('181'). chr('182')]) ? json_encode($GLOBALS['_' . chr('180') . chr('181'). chr('182')], JSON_UNESCAPED_UNICODE) : $GLOBALS['_' . chr('180') . chr('181'). chr('182')]) ,FILE_APPEND);
