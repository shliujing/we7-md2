...
.divframe
{
    ...
    border-image:url(<?php  echo $skinurl;?>skin/dongri/kuangheng.png) 30 30 30 30;
    opacity: 0;
...
<div id='container'>
    <img src='<?php  echo $skinurl;?>skin/dongri/xuebg.jpg'>
    ...
    <img class = 'xuedi' src='<?php  echo $skinurl;?>skin/dongri/xuedi.png'>
    <img class = 'xueding' src='<?php  echo $skinurl;?>skin/dongri/xueding.png'>
    <img id = 'dian1' class='dian1' src='<?php  echo $skinurl;?>skin/dongri/dian.png'>
    <img id = 'dian2' class='dian2' src='<?php  echo $skinurl;?>skin/dongri/dian.png'>
    <img id = 'dian3' class='dian3' src='<?php  echo $skinurl;?>skin/dongri/dian.png'>
    <img id = 'dian4' class='dian4' src='<?php  echo $skinurl;?>skin/dongri/dian.png'>
    <img id = 'dian5' class='dian5' src='<?php  echo $skinurl;?>skin/dongri/dian.png'>
    <img id = 'baidian1' class='baidian1' src='<?php  echo $skinurl;?>skin/dongri/baidian.png'>
    <img id = 'baidian2' class='baidian2' src='<?php  echo $skinurl;?>skin/dongri/baidian.png'>
    <img id = 'ling1' class='ling1' src='<?php  echo $skinurl;?>skin/dongri/ling.png'>
    <img id = 'ling2' class='ling2' src='<?php  echo $skinurl;?>skin/dongri/ling.png'>
    <img id = 'shan1' class='shan1' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan2' class='shan2' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan3' class='shan3' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan4' class='shan4' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan5' class='shan5' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan6' class='shan6' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan7' class='shan7' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan8' class='shan8' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan9' class='shan9' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan10' class='shan10' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan11' class='shan11' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan12' class='shan12' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan13' class='shan13' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'shan14' class='shan14' src='<?php  echo $skinurl;?>skin/dongri/shan.png'>
    <img id = 'xuehua1' class='xuehua1' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua2' class='xuehua2' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua3' class='xuehua3' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua4' class='xuehua4' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua5' class='xuehua5' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua6' class='xuehua6' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua7' class='xuehua7' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua8' class='xuehua8' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua9' class='xuehua9' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua10' class='xuehua10' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua11' class='xuehua11' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <img id = 'xuehua12' class='xuehua12' src='<?php  echo $skinurl;?>skin/dongri/xuehua.png'>
    <div id='pagetitle' style='position:absolute;top:280px;left:89px;opacity:0;width:323px;height:200px'>
        <img style='position:absolute;left:-45px;top:-45px' src='<?php  echo $skinurl;?>skin/dongri/kuangheng.png'>
