...
<div id='container'>
    <img src='<?php  echo $skinurl;?>skin/shiguang/bg.jpg'>
    <div id='div1' class='img' style='opacity:0;'>
        <div id='box1h' class='img'>
            <img class='bgh' src='<?php  echo $skinurl;?>skin/shiguang/guang.png'>
            <div id='div1h' class='divh'>
                <img id='img1h' class='img'>
                <span id='word1h' class='showwords'></span>
                <img class='img' src='<?php  echo $skinurl;?>skin/shiguang/zaodian.gif'>
            </div>
        </div>

        <div id='box1v' class='img'>
            <img class='bgv' src='<?php  echo $skinurl;?>skin/shiguang/guang.png'>
    ...
    <div id='pagetitle' style='position:absolute;'>
        <img class='bgh' src='<?php  echo $skinurl;?>skin/shiguang/guang.png'>
        <img class='titlebg' src='<?php  echo $skinurl;?>skin/shiguang/9.jpg'>
    ...
    <img class='guangshu' src='<?php  echo $skinurl;?>skin/shiguang/guangshu.png'>
    <img class='machine' src='<?php  echo $skinurl;?>skin/shiguang/fangyinji.png'>

    <div class='circle1 circle'>
        <img class='lun' src='<?php  echo $skinurl;?>skin/shiguang/lun.png'>
    </div>
