...
<div class="clearfix">
	<h5 class="page-header">安装 <?php  if($module['title']) { ?><?php  echo $module['title'];?><?php  } else { ?>模板<?php  } ?></h5>
	<div class="alert alert-info">
		您正在安装 <?php  if($module['title']) { ?><?php  echo $module['title'];?> 模块<?php  } else { ?>模板<?php  } ?>. 请选择哪些公众号服务套餐组可使用
		<?php  if($module['title']) { ?><?php  echo $module['title'];?> 功能<?php  } else { ?>该模板<?php  } ?> .
	</div>
	<div class="alert alert-info">
		默认将<?php  if($module['title']) { ?><?php  echo $module['title'];?> 模块<?php  } else { ?>模板<?php  } ?>加入<span class="label label-info">所有服务</span>套餐服务
	</div>
