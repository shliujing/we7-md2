...
<div class="welcome-container js-system-welcome" ng-controller="WelcomeCtrl" ng-cloak>
	...
	<div class="panel we7-panel apply-list">
		...
		<div class="panel-body welcome-apple-list">
			<div class="apply-item" ng-repeat="module in upgrade_module_list">
				...
				<a href="{{module.link}}" target="_blank" class="color-red">升级</a>
				<a data-toggle="popover" class="ignore hidden color-default" data-placement="bottom" data-trigger="hover" data-content="忽略当前版本更新，重新升级到模块列表自行升级">忽略</a>
			</div>
	...
	<div class="panel we7-panel apply-list" ng-show="not_installed_show == 1">
		...
		<div class="panel-body">
			<a href="{{module.link}}" target="_blank" class="apply-item" ng-repeat="module in not_installed_module.module">
				...
				<span class="text-over">{{module.title|limitTo:6}}</span>
