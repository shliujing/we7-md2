...
<input type="hidden" name="id" value="<?php  echo $item['id'];?>"/>
  <div class="layui-form-item"> 
    ...
    <div class="layui-input-block">
      <input type="text" name="templateid" value="<?php  echo $item['templateid'];?>" lay-verify="required" placeholder="请输入模板ID" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">描述一</label>
    <div class="layui-input-block">
      <input type="text" name="content[]" value="<?php  echo $item['content']['0'];?>" lay-verify="required" placeholder="请输入描述" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">描述二</label>
    <div class="layui-input-block">
      <input type="text" name="content[]" value="<?php  echo $item['content']['1'];?>" lay-verify="required" placeholder="请输入描述" autocomplete="off" class="layui-input">
    </div>
  </div>
    <div class="layui-form-item">
        <label class="layui-form-label">描述三</label>
        <div class="layui-input-block">
            <input type="text" name="content[]" value="<?php  echo $item['content']['2'];?>" lay-verify="required" placeholder="请输入描述" autocomplete="off" class="layui-input">
        </div>
    </div>
  <div class="layui-form-item">
    <label class="layui-form-label">小程序地址</label>
    <div class="layui-input-block">
      <input type="text" name="path" value="<?php  if($item['path']) { ?><?php  echo $item['path'];?><?php  } else { ?>hr_album/pages/index/index<?php  } ?>" lay-verify="required" placeholder="请输入日程描述 例如节日由来" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">发送频率</label>
    <div class="layui-input-block">
      <input type="text" name="rate" lay-verify="required" value="<?php echo $item['rate']?$item['rate']:20?>"  placeholder="数据量大的请不要设置过大  最大设置100" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
...
<script type="text/javascript">
	...
	$(".sharebtn").on('click',function(){
		var src = '<?php  echo $_W['siteroot'];?>addons/hr_album/style/images/tu1.jpg';
		layui.use('layer', function(){
			layer.open({
				  type: 1,
				  title: false,
	...
	$(".edbtns").on('click',function(){
		var src = '<?php  echo $_W['siteroot'];?>addons/hr_album/style/images/zhizuo.jpg';
		layui.use('layer', function(){
			layer.open({
				  type: 1,
				  title: false,
