<?php defined('IN_IA') or exit('Access Denied');?><?php  if(empty($tips)) { ?>
	...
	<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('header-base', TEMPLATE_INCLUDEPATH)) : (include template('header-base', TEMPLATE_INCLUDEPATH));?>
		<div class="container message-noexist text-center" style="width: 100%;">
